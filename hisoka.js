...
Silahkan @${m.mentionedJid[0].split`@`[0]} untuk ketik terima/tolak`
	    ...
	    case 'donasi': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
                hisoka.sendMessage(m.chat, { image: { url: 'https://i.ibb.co/y04Nwzk/donasi.png' }, caption: `*Hai Kak ${m.pushName}*\n\n Bot Rental Prices\n⭔ 10k Per Group via E-Walet 1 Month\n⭔ 15k via pulsa 1 Month\n\n Premium Price Bot\n⭔ 10k per User 1 bulan\n\nPayment can be via Paypal/E-wallet/pulsa\n\nFor more details, you can chat with the owner\nhttps://wa.me/6281276242128 (Owner)\n\nDonate For Me : \n\n⭔ Paypal : https://www.paypal.me/Cakhaho\n⭔ Saweria : https://saweria.co/DikaArdnt` }, { quoted: m })
            }
            break
            case 'sc': {
                m.reply('Script :https://github.com/alvino-prog/Arisu\n\n Dont Forget Give Star\n\nDonate : 6281276242128 (Dana, Ovo, Gopay)\nSaweria : https://saweria.co/DikaArdnt\nPaypal : https://www.paypal.me/Cakhaho\n\n Dont Forget Donate')
            }
            break
            case 'chat': {
